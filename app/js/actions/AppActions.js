...
export function changeStructMethodName(data) {
  return { type: AppConstants.CHANGE_STRUCT_METHOD_NAME, data };
}

export function changeStructMethodReturnType(data) {
  return { type: AppConstants.CHANGE_STRUCT_METHOD_RETURN_TYPE, data };
}

export function addStructMethod(data) {
  return { type: 'ADD_STRUCT_METHOD', data };
}

export function removeStructMethod(data) {
  return { type: 'REMOVE_STRUCT_METHOD', data };
}


export function clearLayout() {
  return {
    type: AppConstants.CLEAR_LAYOUT
  };
}

export function sendUpdateToServer(updatedData) {
  return (dispatch) => {
    Connection.sendMessage(updatedData);
  };
}
export function updateFromFileChange(updatedData) {
  return {
    type: AppConstants.UPDATE_FROM_FILE_CHANGE,
    updatedData
  };
}